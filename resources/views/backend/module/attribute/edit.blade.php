...
<form action="" method="POST" accept-charset="utf-8">
	...
	<div class="col-md-8">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h6 class="panel-title">Sửa Thuộc Tính</h6>
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<input type="text" id="name-slug" name="txtName" class="form-control" placeholder="Vui lòng nhập tên thuộc tính" value="{{ old('txtName',$attribute["name"]) }}" />
				</div>
				<div class="form-group">
	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h6 class="panel-title">Sửa Thuộc Tính Tiếng Anh</h6>
				<div class="heading-elements">
					<ul class="icons-list">
						<li><a data-action="collapse"></a></li>
						<li><a data-action="reload"></a></li>
			...
			<div class="panel-body">
				<div class="form-group">
					<label class="control-label">Tên <span class="text-danger">*</span></label>
					<input type="text" id="name-slug-en" name="txtNameEn" class="form-control" placeholder="Vui lòng nhập tên thuộc tính" value="{{ old('txtNameEn',$attribute["name_en"]) }}" />
				</div>
				<div class="form-group">
					<label class="control-label">Mô Tả</label>
