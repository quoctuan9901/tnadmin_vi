...
<form action="" method="POST" accept-charset="utf-8">
	...
	<div class="col-md-8">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h6 class="panel-title">Sửa Thể Loại</h6>
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<input type="text" id="name-slug" name="txtName" class="form-control" placeholder="Vui lòng nhập tên thể loại" value="{{ old('txtName',$category["name"]) }}" />
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" id="txtSlug" name="txtSlug" class="form-control" placeholder="Vui lòng nhập tiêu đề không dấu" value="{{ old('txtSlug',$category["slug"]) }}" />
				</div>
				<div class="form-group" style="margin-bottom: 50px">
					<label class="control-label">Thẻ Tiêu Đề (Ví dụ : Từ Khóa Thứ Nhất - Từ Khóa Thứ Hai)</label>
					<input type="text" id="txtMetaTitle" name="txtMetaTitle" class="form-control col-lg-6 maxlength-textarea" maxlength="70" placeholder="Vui lòng nhập từ khóa thứ nhất - từ khóa thứ hai (SEO)" value="{{ old('txtMetaTitle',$category["title_tag"]) }}" />
				</div>
				<div class="form-group">
					<label class="control-label">Thẻ Từ Khóa</label>
					<input type="text" name="txtMetaKeywords" class="tags-input" placeholder="Vui lòng nhập thẻ từ khóa (SEO)" value="{{ old('txtMetaKeywords',$category["meta_keywords_tag"]) }}" />
					<span class="help-block">Thẻ từ khóa không được quá 10 từ</span>
				</div>
				<div class="form-group">
					<label class="control-label">Thẻ Mô Tả</label>
					<textarea rows="3" name="txtMetaDescription" cols="3" maxlength="160" class="form-control maxlength-textarea" placeholder="Vui lòng nhập thẻ mô tả (SEO)">{{ old('txtMetaDescription',$category["meta_description_tag"]) }}</textarea>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<select name="sltAccess" class="form-control">
						<option value="0" {{ (old('sltAccess',$category["access"]) == '0') ? 'selected' : '' }}>Cộng Đồng</option>
						<option value="1" {{ (old('sltAccess',$category["access"]) == '1') ? 'selected' : '' }}>Quản Trị</option>
						<option value="2" {{ (old('sltAccess',$category["access"]) == '2') ? 'selected' : '' }}>Thành Viên</option>
						<option value="3" {{ (old('sltAccess',$category["access"]) == '3') ? 'selected' : '' }}>Khách</option>
					</select>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" name="txtAlt" class="form-control" placeholder="Vui lòng nhập chú thích hình" value="{{ old('txtAlt',$category["alt"]) }}" />
				</div>
				<div class="form-group">
	...
	@if (env('APP_LANG'))
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h6 class="panel-title">Sửa Thể Loại Tiếng Anh</h6>
					<div class="heading-elements">
						<ul class="icons-list">
							<li><a data-action="collapse"></a></li>
							<li><a data-action="reload"></a></li>
				...
				<div class="panel-body">
					<div class="form-group">
						<label class="control-label">Tên Thể Loại <span class="text-danger">*</span></label>
						<input type="text" id="name-slug-en" name="txtNameEn" class="form-control" placeholder="Vui lòng nhập tên thể loại" value="{{ old('txtNameEn',$category["name_en"]) }}" />
					</div>
					<div class="form-group">
						<label class="control-label">Mô Tả</label>
					...
					<div class="form-group">
						<label class="control-label">Tiêu Đề Không Dấu</label>
						<input type="text" id="txtSlugEn" name="txtSlugEn" class="form-control" placeholder="Vui lòng nhập tiêu đề không dấu" value="{{ old('txtSlugEn',$category["slug_en"]) }}" />
					</div>
					<div class="form-group" style="margin-bottom: 50px">
						<label class="control-label">Thẻ Tiêu Đề (Ví dụ : Từ Khóa Thứ Nhất - Từ Khóa Thứ Hai)</label>
						<input type="text" id="txtMetaTitleEn" name="txtMetaTitleEn" class="form-control col-lg-6 maxlength-textarea" maxlength="70" placeholder="Vui lòng nhập từ khóa thứ nhất - từ khóa thứ hai (SEO)" value="{{ old('txtMetaTitleEn',$category["title_tag_en"]) }}" />
					</div>
					<div class="form-group">
						<label class="control-label">Thẻ Từ Khóa</label>
						<input type="text" name="txtMetaKeywordsEn" class="tags-input" placeholder="Vui lòng nhập thẻ từ khóa (SEO)" value="{{ old('txtMetaKeywordsEn',$category["meta_keywords_tag_en"]) }}" />
						<span class="help-block">Thẻ từ khóa không được quá 10 từ</span>
					</div>
					<div class="form-group">
						<label class="control-label">Thẻ Mô Tả</label>
						<textarea rows="3" name="txtMetaDescriptionEn" cols="3" maxlength="160" class="form-control maxlength-textarea" placeholder="Vui lòng nhập thẻ mô tả (SEO)">{{ old('txtMetaDescriptionEn',$category["meta_description_tag_en"]) }}</textarea>
					</div>
				</div>
			</div>
		</div>
