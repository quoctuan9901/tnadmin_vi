	...
	<div class="col-md-8">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h6 class="panel-title">Thêm Thành Viên</h6>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body" style="display: block;">
				<div class="form-group">
					...
					<input type="text" name="txtFirstName" class="form-control" placeholder="Vui lòng nhập tên" value="{{ old('txtFirstName') }}" />
				</div>
				<div class="form-group">
					<label class="control-label">Họ</label>
					<input type="text" name="txtLastName" class="form-control" placeholder="Vui lòng nhập họ" value="{{ old('txtLastName') }}" />
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" name="txtFacebook" class="form-control" placeholder="Nhập Link Facebook" value="{{ old('txtFacebook') }}" />
				</div>
				<div class="form-group">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<select name="sltLevel" class="form-control">
						<option value="2" {{ (old('sltLevel') == '2') ? 'selected' : '' }}>Thành Viên</option>
						<option value="1" {{ (old('sltLevel') == '1') ? 'selected' : '' }}>Quản Trị</option>
					</select>
				</div>
				@if (Auth::user()->id == 1)
				<div class="form-group">
