                                ...
                                <td>
                                    ...
                                    <table align="left" class="column">
                                       <tr>
                                          <td>
                                             <h5 class="">Kết nối :</h5>
                                             <p class="">
                                              <a href="{{ $config->facebook }}" class="soc-btn fb">Facebook</a> 
                                              <a href="{{ $config->twitter }}" class="soc-btn tw">Twitter</a> 
                                              <a href="{{ $config->google_plus }}" class="soc-btn gp">Google+</a>
                                             </p>
                                          </td>
                                       </tr>
                                    </table>
                                    ...
                                    <table align="left" class="column">
                                       <tr>
                                          <td>
                                             <h5 class="">Liên hệ:</h5>
                                             <p>Điện thoại: <strong>{{ $config->contact_phone }}</strong><br/>
                                                Email: <strong><a href="emailto:{{ $config->contact_email }}">{{ $config->contact_email }}</a></strong><br />
                                                Email: <strong><a href="emailto:{{ $config->contact_email }}">{{ $config->contact_address }}</a></strong>
                                             </p>
                                          </td>
                                       </tr>
                                    </table>
